...
export class RankPopup extends Component {
    ...
    /** 空态：蓝猫 + 邀请话术 + 邀请好友按钮（把空列表变成增长入口，states.html D1）。 */
    private renderEmpty(): void {
        ...
        cat.parent = box;
        cat.setPosition(0, 150, 0);
        cat.addComponent(UITransform).setContentSize(200, 200);
    ...
    private buildCoinChip(x: number, y: number): void {
        ...
        drawRoundedRect(chip, 132, 58, TOKENS.paper, TOKENS.line2, 2, 29);
